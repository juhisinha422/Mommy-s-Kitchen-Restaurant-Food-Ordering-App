...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .role-badge { display:inline-flex; align-items:center; gap:6px; background:rgba(232,148,58,0.12); color:var(--accent); border:1px solid rgba(232,148,58,0.25); border-radius:20px; padding:4px 14px; font-size:0.72rem; font-weight:600; letter-spacing:0.5px; margin-bottom:14px; }
    ...
    .back-link { display:block; margin-top:18px; font-size:0.82rem; color:var(--muted); text-decoration:none; }
...
<body>
  <div class="card">
    ...
    <p class="sub">Your registration details have been validated successfully. Please review everything before confirming your account.</p>
    <div class="info-box">
      <i class="fa fa-circle-check"></i>
      All fields are valid and ready to be saved.
    </div>
    <a href="CView.jsp" class="btn-review">
      <i class="fa fa-eye"></i> Review & Confirm
    </a>
    <a href="Clogin.html" class="back-link">
